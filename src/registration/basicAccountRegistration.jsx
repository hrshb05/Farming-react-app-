        ...
        .then((refreshAuth) => {
            if(refreshAuth.status === 200){
                ...
                if (this.state.username != '' && this.state.password != '' && this.state.addressLine1 != '' && this.state.addressLine2 != '' && this.state.city != '' &&
                    this.state.country != '' && this.state.creationDate == '' && this.state.dateOfRegistration != '' && this.state.email != '' && this.state.firstName != ''
                    ...
                    axios.put(BASE_URL + 'auth-module-2/users/55?access_token=' + refreshAuth.data.access_token, this.state, {
                        headers: {
                                ...
                                <div className="registrationDesign">
                                    <form onSubmit={this.handleBasicInfo} className="form" style={{ padding: '20px', margin: 0 }}>
                                        ...
                                        <div >
                                            ...
                                            <input className="name-email-phone" disabled="true" value={this.state.email} type="email" placeholder="Enter Email" name="email" onChange={this.handleOnInputChange} />
                                        </div>
